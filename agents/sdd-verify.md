...
name: sdd-verify
description: >
  Validate implementation against specs, design, and tasks with real test execution.
  Use when apply reports done (or partial) and the change must be proven compliant
  before archive.
model: inherit
