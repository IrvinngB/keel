...
name: sdd-estimate
description: >
  Estimate complexity, time and risk per task from an existing tasks.md. Flags
  high-risk work (auth, payments, destructive migrations, public API changes). Use
  after sdd-tasks, before committing to a sprint or quoting work to a client.
model: inherit
