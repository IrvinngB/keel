...
name: sdd-drift
description: >
  Detect divergence between approved specs/design and the actual code — changes made
  outside sdd-apply, or specs that went stale. Compares git history of code files
  against artifact dates. Use before verify/archive, or anytime a change folder has
