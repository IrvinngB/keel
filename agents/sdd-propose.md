...
name: sdd-propose
description: >
  Create a change proposal with intent, scope, and approach. Use when exploration is
  done (or the user described the change directly) and it must be formalized into a
  proposal document before specs.
model: inherit
