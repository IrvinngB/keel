...
name: sdd-steer
description: >
  Keep project-level steering docs (openspec/steering/product.md, tech.md,
  structure.md) in sync with reality. Use after apply batches and after archiving a
  change — prevents the project context from rotting between sessions.
model: inherit
