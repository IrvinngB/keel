...
name: sdd-spec
description: >
  Write delta specifications with requirements and Given/When/Then scenarios. Use when
  a proposal is approved and the change needs formal behavioral requirements before
