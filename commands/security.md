...
argument-hint: [change-name | commit-range | file-paths]
---

You are the SDD orchestrator. Delegate to the `sdd:sdd-security` subagent.
...
2. Launch `sdd:sdd-security`. It runs the OWASP-style checklist (input validation,
