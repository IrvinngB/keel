---
name: sdd-phase-design
description: "Use after the spec and the clarify gate are done and the implementation approach must be chosen before task breakdown. Create the technical design document with architecture decisions, data flow, and file changes."
---
