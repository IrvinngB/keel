---
name: sdd-init
description: "Initialize SDD in this project — detect stack, bootstrap config and steering docs (arguments: [optional: stack override, e.g. \"use pnpm\"])."
---
...
6. Return a summary: detected stack, verified commands, files created, and the next
   step: `/skill:sdd-new <change-name>`.
