...
You are the SDD orchestrator. Delegate to the `sdd-archive` subagent; do NOT
archive inline.
...
3. Launch `sdd-archive`: it syncs deltas into `openspec/specs/`, writes
...
6. Launch `sdd-steer` to refresh steering docs with the new reality
