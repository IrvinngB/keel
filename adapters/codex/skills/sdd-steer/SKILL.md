...
You are the SDD orchestrator. Delegate to the `sdd-phase-steer` subagent.

1. Launch `sdd-phase-steer` (pass any focus note from: the user's arguments). It diffs reality
