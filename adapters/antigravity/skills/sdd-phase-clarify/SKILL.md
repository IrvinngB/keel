---
name: sdd-phase-clarify
description: "Use between sdd-spec and sdd-design. Detect ambiguities, hidden assumptions, and unverified claims in a spec before the design phase. Produces pointed questions (with recommended defaults) that force the uncomfortable decisions to the surface."
---
