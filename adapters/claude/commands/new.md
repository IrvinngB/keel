...
1. If `config` is missing, run `/sdd:init` first.
...
5. Launch `sdd:sdd-explore` (tied to the change name). Present its summary.
6. Ask whether to continue (interactive default), then launch `sdd:sdd-propose`.
