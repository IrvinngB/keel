...
team-shareable, resumable. Persistence is a **pluggable backend**: files, Engram,
SQLite, any mapped MCP server — or a combination — behind one abstract
interface (SAVE/LOAD/LIST).
...
├── persistence/        interface.md + backends: files · Engram · SQLite ·
│                     generic MCP · template.md to add your own
