...
├── persistence/        backends: openspec (files) | engram (MCP) | hybrid | none
...
`openspec/config.yaml`, and asks the two setup questions (`artifact_store =
engram | openspec | hybrid | none`, Strict TDD on/off).
